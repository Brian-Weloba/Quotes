...
export class QuoteComponent implements OnInit {
  ...
  public quotes: Quote[] = [
    ...
    new Quote(3, 'One day, in retrospect, the years of struggle will strike you as the most beautiful.', 'Sigmund Freud', 'Stew', new Date(2021, 2, 9)),
    new Quote(4, 'Show me a sane man and I will cure him for you.', 'Carl Jung', 'Denzel', new Date(2021, 2, 15))
  ]
